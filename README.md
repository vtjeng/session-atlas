...
their timing can be compared directly. Source badges identify the tools
...
with the colours swapped, so a shared page is told apart from a project
page. An entry's page says which
